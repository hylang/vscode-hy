...
export async function activate(context: vscode.ExtensionContext) {
  ...
  context.subscriptions.push(
    vscode.commands.registerTextEditorCommand(
      'hy.calva-fmt.alignCurrentForm',
      formatter.alignPositionCommand
    )
  );
  context.subscriptions.push(
    vscode.commands.registerTextEditorCommand(
      'hy.calva-fmt.trimCurrentFormWhiteSpace',
      formatter.trimWhiteSpacePositionCommand
    )
  );
  context.subscriptions.push(
    vscode.commands.registerTextEditorCommand(
      'hy.calva-fmt.inferParens', 
      inferer.inferParensCommand)
  );
  context.subscriptions.push(
    vscode.commands.registerTextEditorCommand(
      'hy.calva-fmt.tabIndent', 
      (e) => {
  ...
  context.subscriptions.push(
    vscode.commands.registerTextEditorCommand('hy.calva-fmt.tabDedent', (e) => {
      inferer.indentCommand(e, ' ', false);
    })
  );
  context.subscriptions.push(
    vscode.languages.registerOnTypeFormattingEditProvider(
      hyConfig.documentSelector,
  ...
  vscode.workspace.onDidChangeConfiguration(async (e) => {
    if (e.affectsConfiguration('hy.calva.fmt.formatAsYouType')) {
      vscode.languages.setLanguageConfiguration(
        'hy',
        getLanguageConfiguration(await config.getConfig()['format-as-you-type'])
      );
