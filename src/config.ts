...
const KEYBINDINGS_ENABLED_CONFIG_KEY = 'hy.keybindingsEnabled';
const KEYBINDINGS_ENABLED_CONTEXT_KEY = 'hy:keybindingsEnabled';
...
const documentSelector = [
  { scheme: 'file', language: 'hy' },
  { scheme: 'jar', language: 'hy' },
  { scheme: 'untitled', language: 'hy' },
];
...
function getConfig() {
  const configOptions = vscode.workspace.getConfiguration('hy');
  const pareditOptions = vscode.workspace.getConfiguration('hy.paredit');
